...
## Corpus Check
- 138 files · ~235,920 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 835 nodes · 1111 edges · 153 communities (54 shown, 99 thin omitted)
...
Cohesion: 0.23
Nodes (9): CheckoutModal(), CloseIcon(), MenuIcon(), MobileBottomNav(), NAV_LINKS, Navbar(), useMe(), useMembership() (+1 more)
...
Cohesion: 0.07
Nodes (22): metadata, values, DELETE(), PATCH(), proxyCartItemRequest(), metadata, generateMetadata(), generateStaticParams() (+14 more)
...
Cohesion: 0.21
Nodes (6): HeartIcon(), ProductCard(), Reveal(), Feather Tee Product Image, Cigarettes After Sex Newsprint Tee (Product Photo), Lana Del Rey Graphic Tee Product Image
...
Cohesion: 0.39
Nodes (5): NewsletterForm(), Toast(), AppStateContext, AppStateContextValue, useAppState()
...
Cohesion: 0.20
Nodes (7): Hero(), ChevronDownIcon(), ProductDetail(), useAddCartItem(), RecentlyViewedItem, useRecentlyViewed(), useScrollY()
...
Cohesion: 0.22
Nodes (10): CheckoutFormValues, Button(), buttonVariants, Dialog(), DialogContent(), DialogDescription(), DialogFooter(), DialogHeader() (+2 more)

### Community 147 - "Community 147"
Cohesion: 0.22
Nodes (6): BagIcon(), ChevronLeftIcon(), ChevronRightIcon(), HomeIcon(), SearchIcon(), UserIcon()
...
## Knowledge Gaps
- **401 isolated node(s):** `metadata`, `values`, `metadata`, `SearchParams`, `metadata` (+396 more)
...
- **Why does `cn()` connect `Community 145` to `App Layout & Global State`, `Community 137`, `Login API Route`, `Community 146`, `Community 148`, `Community 149`, `Community 151`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `useAppState()` connect `Community 139` to `Storefront UI Components`, `Login & OTP Auth Flow`, `Community 141`, `Community 146`, `Community 147`, `Community 127`?**
