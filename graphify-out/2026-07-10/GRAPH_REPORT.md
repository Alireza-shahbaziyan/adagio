# Graph Report - online-shop  (2026-07-10)

## Corpus Check
- 136 files · ~235,412 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 831 nodes · 1099 edges · 145 communities (48 shown, 97 thin omitted)
...
- `LoginForm()` --calls--> `useSendPhone()`  [EXTRACTED]
  components/Auth/LoginForm.tsx → hooks/useSendPhone.ts
- `OtpForm()` --calls--> `useAppState()`  [EXTRACTED]
  components/Auth/OtpForm.tsx → lib/app-state.tsx
...
## Communities (145 total, 97 thin omitted)
...
Cohesion: 0.13
Nodes (15): metadata, values, metadata, BagIcon(), CloseIcon(), HeartIcon(), HomeIcon(), MenuIcon() (+7 more)
...
Cohesion: 0.13
Nodes (12): LoginForm(), PhoneFormValues, DIGIT_KEYS, DigitKey, OtpForm(), OtpFormValues, useSendPhone(), savePhoneNumber() (+4 more)
...
Cohesion: 0.05
Nodes (67): CheckoutFormValues, FEATURED_OPTIONS, pillClass(), Badge(), badgeVariants, Button(), buttonVariants, Command() (+59 more)
...
Cohesion: 0.07
Nodes (21): DELETE(), PATCH(), proxyCartItemRequest(), Page(), NotFound(), generateMetadata(), generateStaticParams(), SearchParams (+13 more)
...
Cohesion: 0.17
Nodes (6): SearchParams, ProductCard(), Reveal(), Feather Tee Product Image, Cigarettes After Sex Newsprint Tee (Product Photo), Lana Del Rey Graphic Tee Product Image

### Community 128 - "Community 128"
Cohesion: 0.36
Nodes (9): CartView(), addCartItem(), cartRequest(), getCart(), removeCartItem(), updateCartItem(), useCart(), useRemoveCartItem() (+1 more)

### Community 129 - "Community 129"
Cohesion: 0.24
Nodes (5): ProductPage(), ChevronDownIcon(), ProductDetail(), useAddCartItem(), useRecentlyViewed()
...
## Knowledge Gaps
- **400 isolated node(s):** `metadata`, `values`, `metadata`, `SearchParams`, `metadata` (+395 more)
...
- **Why does `useAppState()` connect `Community 139` to `Storefront UI Components`, `Community 129`, `Login & OTP Auth Flow`, `Login API Route`, `Community 127`?**
