# Graph Report - online-shop  (2026-07-13)

## Corpus Check
- 158 files · ~240,656 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 891 nodes · 1220 edges · 152 communities (51 shown, 101 thin omitted)
...
## Communities (152 total, 101 thin omitted)
...
Cohesion: 0.13
Nodes (14): metadata, metadata, BagIcon(), ChevronDownIcon(), CloseIcon(), HomeIcon(), MenuIcon(), SearchIcon() (+6 more)
...
Cohesion: 0.06
Nodes (33): dependencies, @base-ui/react, class-variance-authority, clsx, cmdk, lucide-react, next, react (+25 more)
...
Cohesion: 0.07
Nodes (36): CheckoutFormValues, checkoutSchema, LoginForm(), PhoneFormValues, DIGIT_KEYS, DigitKey, OtpForm(), OtpFormValues (+28 more)
...
Cohesion: 0.10
Nodes (20): FEATURED_OPTIONS, pillClass(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioGroup() (+12 more)
...
Cohesion: 0.29
Nodes (6): About the design files, Authentication & membership, Bundle contents, CODING AGENTS: READ THIS FIRST, Implementation status, What you should do — IMPORTANT
...
Cohesion: 0.06
Nodes (24): DELETE(), PATCH(), proxyCartItemRequest(), Page(), NotFound(), ProductPage(), generateMetadata(), generateStaticParams() (+16 more)

### Community 119 - "Community 119"
Cohesion: 0.14
Nodes (9): HeartIcon(), ProductAccordion(), ProductActions(), ProductBreadcrumb(), ProductDetail(), ProductMobileBar(), ProductQuantityStepper(), useAddCartItem() (+1 more)
...
Cohesion: 0.09
Nodes (15): ErrorPage(), ErrorPageProps, REVIEWS, ChevronLeftIcon(), ChevronRightIcon(), ProductCard(), Reveal(), COLLECTION_LABEL (+7 more)
...
Cohesion: 0.17
Nodes (13): Button(), buttonVariants, InputGroup(), InputGroupAddon(), inputGroupAddonVariants, InputGroupButton(), inputGroupButtonVariants, InputGroupInput() (+5 more)
...
## Knowledge Gaps
- **408 isolated node(s):** `metadata`, `values`, `metadata`, `SearchParams`, `metadata` (+403 more)
...
- **Why does `cn()` connect `Community 145` to `App Layout & Global State`, `Community 137`, `Login API Route`, `Community 148`, `Community 149`, `Community 151`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `useAppState()` connect `Login & OTP Auth Flow` to `Community 119`?**
