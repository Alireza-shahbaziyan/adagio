...
export default function LoginLayout({ children }: { children: React.ReactNode }) {
  return (
    <div
      dir="rtl"
      lang="fa"
      className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#090909] p-6 text-white"
    >
      <div
        className="absolute top-[-20%] right-[-15%] h-[60vw] w-[60vw] max-w-175 max-h-175 rounded-full blur-2xl"
        style={{
          background: "radial-gradient(circle, rgba(168,168,168,0.10), transparent 70%)",
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, rgba(243,243,243,0.06), transparent 70%)",
      ...
      <Link
        href="/"
        style={{ direction: "ltr" }}
        className="absolute top-5 right-5 z-[2] font-instrument-serif text-[22px] italic text-[#F3F3F3] md:top-10 md:right-10"
      >
        Adagio
      </Link>
